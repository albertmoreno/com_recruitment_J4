...
class ApplicationformController extends FormController
{
	...
	public function save($key = NULL, $urlVar = NULL)
	{
		...
		if ($data === false)
		{
			...
			$this->app->setUserState('com_recruitment.edit.application.data', $jform);

			// Redirect back to the edit screen.
			$id = (int) $this->app->getUserState('com_recruitment.edit.application.id');
			$this->setRedirect(Route::_('index.php?option=com_recruitment&view=applicationform&layout=edit&id=' . $id, false));
		...
		{
			// Save the data in the session.
			$this->app->setUserState('com_recruitment.edit.application.data', $data);
