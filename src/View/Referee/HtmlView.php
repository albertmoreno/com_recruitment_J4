...
namespace Recruitment\Component\Recruitment\Site\View\Referee;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		if ($upload_code) :
			$referee = RecruitmentHelper::findFromUploadCode($upload_code);
			...
			$job = RecruitmentHelper::getJob($application->job_id);
